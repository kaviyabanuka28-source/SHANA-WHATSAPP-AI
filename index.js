...
async function startBot() {
  ...
  sock.ev.on('messages.upsert', async (m) => {
    try {
      ...
      // ඔබ ලබා දුන් ලෝගෝ රූපයේ URL එක
      const logoUrl = "https://chatgpt.com/imagewizard-image?id=ac6d5e88-2fe4-4439-9698-bc8f29fcbcfd.jfif";
      ...
      if (['1', '2', '3', '4', '5', '6', '7'].includes(text)) {
        ...
        if (text === '1') {
          ...
          await sock.sendMessage(sender, { image: { url: logoUrl }, caption: `SHANA LOGO 🕹\n\n` + replyText });
        } 
        else if (text === '2') {
